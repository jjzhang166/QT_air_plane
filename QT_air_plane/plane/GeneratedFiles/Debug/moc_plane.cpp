...
static const char qt_meta_stringdata_plane[] = {
    "plane\0"
};
...
const QMetaObjectExtraData plane::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject plane::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_plane,
      qt_meta_data_plane, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &plane::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_plane))
